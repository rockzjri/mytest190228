...
public class MD5Util {
    ...
    public static String md5(String text) {
        ...
        try {
            ...
            //计算哈希值
            secretByte = md5.digest(text.getBytes());

            //转16禁止
            md5code =new BigInteger(1,secretByte).toString(16);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("源码="+password);
